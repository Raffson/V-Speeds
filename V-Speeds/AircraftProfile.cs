...
namespace V_Speeds
{
    ...
    public static class AircraftProfile
    {
        ...
        static readonly ImmutableArray<decimal> DCS_F15C_AB =
            ImmutableArray.Create<decimal>(new decimal[] { 56.5m, 0.71m, 61700m, 2m, 0.085m, 0m, 200000m, 0.071m, 0.08m });
        static readonly ImmutableArray<decimal> DCS_F15C_MIL =
            ImmutableArray.Create<decimal>(new decimal[] { 56.5m, 0.71m, 61700m, 2.5m, 0.085m, 0m, 128000m, 0.071m, 0.08m });
