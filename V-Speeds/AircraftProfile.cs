    ...
    internal static class AircraftProfile
    {
        ...
        */
        ...
        static readonly ImmutableArray<decimal> F16blk50_MIL = 
            ImmutableArray.Create<decimal>(new decimal[]{ 28m, 0.9m, 53900m, 2m, 0.1m, 0m, 8573m, 76310m, 0.52m, 0.043m });
        ...
        static readonly ImmutableArray<decimal> F15C_AB =
            ImmutableArray.Create<decimal>(new decimal[] { 56.5m, 0.7m, 61700m, 2m, 0.1m, 0m, 12701m, 211400m, 0m, 0.08m });
        static readonly ImmutableArray<decimal> F15C_MIL =
            ImmutableArray.Create<decimal>(new decimal[] { 56.5m, 0.7m, 61700m, 2m, 0.1m, 0m, 12701m, 130000m, 0m, 0.08m });
